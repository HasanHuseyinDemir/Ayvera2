...
export const ProductForm = component$(({ product = {}, categories = [], brands = [], onSuccess$, onCancel$ }) => {
  ...
  // PDF ve Driver linki için state
  const driverUrl = useSignal(product?.driver || '');
  const pdfUrl = useSignal(product?.pdf || '');
    ...
    <div class="bg-white rounded-xl shadow-2xl overflow-hidden max-w-4xl mx-auto">
      ...
      <div class="p-6">
        ...
        <form onSubmit$={handleSubmit} onSubmitCapture$={$((e) => e.preventDefault())} preventdefault:submit class="space-y-8">
          ...
          {/* PDF ve Driver Linki - Sadece link/text olarak */}
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="space-y-2">
              <label for="product-driver" class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                <svg class="w-4 h-4 mr-2 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v2a2 2 0 002 2h12a2 2 0 002-2v-2M7 10l5 5 5-5M12 15V3" /></svg>
                Driver Linki
              </label>
              <input
                id="product-driver"
                ...
                onInput$={e => driverUrl.value = e.target.value}
                class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 text-gray-800 font-medium placeholder-gray-400"
                placeholder="https://site.com/drivers/urun.zip"
              />
            </div>
            <div class="space-y-2">
              <label for="product-pdf" class="flex items-center text-sm font-semibold text-gray-700 mb-2">
                <svg class="w-4 h-4 mr-2 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4" /></svg>
                PDF Linki
              </label>
              <input
                id="product-pdf"
                ...
                type="url"
                value={pdfUrl.value}
                onInput$={e => pdfUrl.value = e.target.value}
                class="w-full px-4 py-3 bg-gray-50 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-red-500 focus:border-red-500 transition-all duration-200 text-gray-800 font-medium placeholder-gray-400"
