  ...
  return (
    <div class="space-y-6">
      ...
      {selectedBrand.value && (
        <div class="fixed inset-0 z-50 overflow-y-auto">
          <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" onClick$={() => selectedBrand.value = null}></div>
            <div class="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    ...
                    <div class="space-y-3">
                      ...
                      {selectedBrand.value.logo && (
                        <div>
                          ...
                          <img class="mt-1 h-16 w-16 rounded-lg object-cover" src={selectedBrand.value.logo} alt={selectedBrand.value.name} />
                        </div>
                      )}
